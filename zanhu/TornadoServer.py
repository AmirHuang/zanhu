...
sys.path.append(os.path.join(app_path, 'zanhu/zanhu'))  # ../zanhu/zanhu
...
'''
nginx命令：systemctl status nginx.service
            nginx -t 检查nginx语法是否正确
python TornadoServer.py --port=6004  在6004端口开启TornadoServer
jobs  查看当前开始的服务？
bg 1 2 3 4  是当前停止的服务启动
'''
